...
def lico_jian():
    """简 —— 动态。三片简 + 两道编绳 + 卷起的一头。"""
    d = ('<path d="M11 6.8 h2.6 a1.4 1.4 0 0 1 1.4 1.4 v15.6 a1.4 1.4 0 0 1 -1.4 1.4'
         ' h-2.6 a1.4 1.4 0 0 1 -1.4 -1.4 v-15.6 a1.4 1.4 0 0 1 1.4 -1.4 Z"/>'
         '<path d="M16.6 6.8 h2.6 a1.4 1.4 0 0 1 1.4 1.4 v15.6 a1.4 1.4 0 0 1 -1.4 1.4'
         ' h-2.6 a1.4 1.4 0 0 1 -1.4 -1.4 v-15.6 a1.4 1.4 0 0 1 1.4 -1.4 Z"/>'
         '<path d="M22.2 6.8 h2.6 a1.4 1.4 0 0 1 1.4 1.4 v15.6 a1.4 1.4 0 0 1 -1.4 1.4'
         ' h-2.6 a1.4 1.4 0 0 1 -1.4 -1.4 v-15.6 a1.4 1.4 0 0 1 1.4 -1.4 Z"/>'
         '<path d="M9.2 11.4 h17 M9.2 20.6 h17"/>'             # 编绳
         '<path d="M6.6 6.8 a2.6 9.2 0 0 0 0 18.4 a2.6 9.2 0 0 0 0 -18.4 Z"/>')  # 卷起的一头
    return _ln(d, 1.5)


def lico_zhou():
    """画轴 —— 展馆。轴头出头、画心里一座阁。"""
    d = ('<path d="M5.6 7 h20.8 M5.6 25 h20.8"/>'
         '<path d="M4 7 h-0.6 M28 7 h0.6 M4 25 h-0.6 M28 25 h0.6"/>'
         '<path d="M8.4 7 v18 M23.6 7 v18"/>'                  # 画心边
         '<path d="M12 15.6 L16 12.4 L20 15.6"/>'              # 阁顶
         '<path d="M12.8 15.6 v5.4 M19.2 15.6 v5.4 M11.4 21.4 h9.2"/>')
    return _ln(d, 1.5)
...
def lico_xinzha():
    ...
    一封折起的札，右下角压一方印泥封缄。
    比一个铃铛准确：书院里传消息用的是札，不是铃。
    """
    d = ('<path d="M6.2 8.6 h19.6 a1.8 1.8 0 0 1 1.8 1.8 v13.2 '
         'a1.8 1.8 0 0 1 -1.8 1.8 H6.2 a1.8 1.8 0 0 1 -1.8 -1.8 V10.4 '
         'a1.8 1.8 0 0 1 1.8 -1.8 Z"/>'
         '<path d="M4.8 10 L16 18 L27.2 10"/>'                   # 折缝
         '<path d="M9.8 22.4 h5.4"/>')                           # 札尾的一行
    return _ln(d, 1.6)
