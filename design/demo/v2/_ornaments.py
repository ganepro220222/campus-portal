...
def lico_yan():
    ...
    为什么是**实心**：这一枚前后画了八版描边的都不成立。
      · 单雁描边（颈前伸 / 双翅张 / 简笔 / 一笔 / 鸥翼加颈尾 / 侧飞）——
        颈、身、翅三件在 25px 上互相挨着，描边一粗就并成一道勾，看着是随手划的。
      · 雁阵描边（三只 V 加一竖）——V 的两端朝下、尖朝上，
        这正是**山**的轮廓；那一竖压不住这个读法，出来就是三座山。
        （把弧翻成鸥形、翼尖朝上之后山的读法没了，但三道小弧又成了花边。）
    实心silhouette 没有这个问题：小尺寸下人眼认的是**外形**不是线，
    一只填实的飞鸟 22px 就能认出来。

    朝右上飞，方向本身就是"送出去"。
    """
    d = ('M28.6 6.2 C27.4 5.4 25.6 5.6 24.4 6.8 L19.4 11.9 '
         'C18.7 12.6 18.3 13.5 18.2 14.4 '          # 头颈压向身
         'L11.2 4.6 C10.7 3.9 9.6 4.3 9.7 5.2 L11.6 15.4 '   # 上扬的翼
         'C11.7 16 12.1 16.5 12.6 16.7 '
         'L4.3 21.9 C3.5 22.4 3.8 23.6 4.7 23.7 L15.2 24.6 '  # 下垂的翼与尾
         'C16.4 24.7 17.5 24.2 18.3 23.4 L26.6 15.1 '
         'C27.9 13.8 28.3 11.9 27.6 10.2 L27.2 9.2 '
         'C27.1 8.9 27.2 8.6 27.4 8.4 L29.2 7.4 '
         'C29.7 7.1 29.6 6.4 28.6 6.2 Z')          # 喙
