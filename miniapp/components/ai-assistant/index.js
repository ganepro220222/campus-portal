// components/ai-assistant/index.js —— 书院文化 AI 助手（浮标 + 底部抽屉）
const AI_ANS = {
...
Component({
  ...
  methods: {
    ...
    _ask(key, shown) {
      ...
      const matchKey = Object.keys(AI_ANS).find(k => key.indexOf(k) >= 0)
      const answer = matchKey ? AI_ANS[matchKey]
        : ('关于“' + shown + '”，我可以基于书院文化知识库为你解答。（演示）')
      setTimeout(() => {
