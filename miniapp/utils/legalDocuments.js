...
const CACHE_KEY = 'legal_documents_cache_v3'
const BASELINE_VERSION = 'baseline-2026-09-23c'

const BASELINE = {
  version: BASELINE_VERSION,
  privacy: `<p><strong>通途文华书院小程序隐私政策</strong></p>
<p>本政策适用于微信小程序「通途文华书院」（产品界面名称「云端书院」）。运营方为贵州交通职业大学（下称「我们」）。平台学习与展示内容由中华文化书院提供。备案号：黔ICP备05000595号-6X。</p>
...
（4）知识问答：您主动输入的问题及检索返回答案记录，用于提供问答服务与安全风控。<br/>
...
<p><strong>3. 知识问答</strong></p>
<p>您在「知识问答」中提交的问题将用于在平台知识库中检索资料并返回相关片段。回答来自已录入资料，仅供参考，不构成正式通知或法律意见。请勿输入违法违规内容或过多个人敏感信息。</p>
...
<p>如有疑问，请通过小程序「意见反馈」联系。运营主体：贵州交通职业大学。</p>
<p>生效日期：2026-09-03</p>`,
  agreement: `<p><strong>通途文华书院小程序用户协议</strong></p>
<p>欢迎使用微信小程序「通途文华书院」（产品界面名称「云端书院」）。本协议由贵州交通职业大学（下称「我们」）与用户订立。平台内容由中华文化书院提供。使用本服务即表示您同意本协议。</p>
<p><strong>1. 服务内容</strong></p>
<p>本小程序提供动态、线上展馆、课程学习、资源下载、活动报名、文创展示、知识问答等功能，具体以实际上线模块为准。部分内容可能随运营需要调整、下架或维护。</p>
