...
const CACHE_KEY = 'legal_documents_cache_v2'
const BASELINE_VERSION = 'baseline-2026-09-23'

const BASELINE = {
  version: BASELINE_VERSION,
  privacy: `<p><strong>通途文华书院小程序隐私政策</strong></p>
<p>本政策适用于微信小程序「通途文华书院」（产品界面名称「云端书院」）。运营方为贵州云漫科技有限公司（下称「我们」）。平台学习与展示内容由中华文化书院提供。备案号：黔ICP备05000595号-6X。</p>
...
<p>欢迎使用微信小程序「通途文华书院」（产品界面名称「云端书院」）。本协议由贵州云漫科技有限公司（下称「我们」）与用户订立。平台内容由中华文化书院提供。使用本服务即表示您同意本协议。</p>
