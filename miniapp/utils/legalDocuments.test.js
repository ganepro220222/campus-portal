...
assert.ok(BASELINE.privacy.includes('贵州交通职业大学'))
assert.ok(BASELINE.agreement.includes('贵州交通职业大学'))
assert.ok(BASELINE.privacy.includes('通途文华书院'))
assert.ok(BASELINE.agreement.includes('通途文华书院'))
assert.ok(BASELINE.privacy.includes('黔ICP备05000595号-6X'))
assert.ok(!BASELINE.privacy.includes('通途云'))
assert.ok(!BASELINE.privacy.includes('贵州云漫'))
assert.ok(!BASELINE.agreement.includes('贵州云漫'))
assert.ok(!BASELINE.privacy.includes('黔ICP备17005610号'))
