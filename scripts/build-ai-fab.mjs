 ...
 *
 * 字形取自 design/brand/seal-script/ 里现成的小篆。
 * 用「问」——这枚浮标点开是问答，字要和功能对上。早先临时用过「闻」，
 * 理由是库里当时只有那一枚现成的矢量；「問」字形到位后换回来。
...
`
  return execFileSync('python', ['-c', py], { encoding: 'utf8', maxBuffer: 8 << 20 })
}
