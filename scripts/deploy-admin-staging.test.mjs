...
assert.match(ps1, /function Assert-AdminHttpLive/)
assert.match(ps1, /Assert-AdminHttpLive -SshTarget/)
assert.match(ps1, /AdminProbeUrl/)
assert.match(ps1, /grep -q ''\/admin\/assets\/''/)
