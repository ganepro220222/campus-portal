...
(1,  '贵州交通博物馆·教育馆', '交通博物馆', '贵州交通发展历程与教育成果数字化展陈，支持 VR 全景漫游与图文介绍。', 'https://9c03e1f7.720roma.com/vr/515a9635070ca212/', 4, 1, 1),
(2,  '校史馆', '校史馆', '学校办学历程与重要发展节点的线上展陈，支持 VR 全景漫游与图文介绍。', 'https://9c03e1f7.720roma.com/vr/b5b7196093f3c25a/', 4, 2, 1),
(3,  '贵州交通红色教育基地', '红色教育基地', '基地实体展陈的线上导览入口，支持 VR 全景漫游与图文介绍。', 'https://9c03e1f7.720roma.com/vr/59e140eb05f9e134/', 5, 3, 1),
(4,  '交旅融合研学服务中心', '交旅研学', '交旅融合主题研学服务展示，连接线上云游与线下研学实践。', 'https://9c03e1f7.720roma.com/vr/96cb6946cefd5b99/', 6, 4, 1),
(5,  '学生素质发展中心', '素质发展中心', '学生综合素质培养成果与活动空间线上展示。', 'https://c73zd07zrkz.720yun.com/vr/374j5dyvrf2', 7, 5, 1),
(6,  '学生科普体验中心', '科普体验中心', '交通科技与学生科普互动体验场景，激发科学探索兴趣。', 'https://c73zd07zrkz.720yun.com/vr/7a0j5dyksk9', 7, 6, 1),
(7,  '文化千岛艺术馆', '千岛艺术馆', '汇聚多元文化艺术作品，展现交通院校美育与文创成果。', 'https://c73zd07zrkz.720yun.com/vr/660j5dyvsv5', 16, 7, 1),
(8,  '校园安全教育馆', '校园安全教育馆', '校园安全常识、应急演练与警示教育，支持 VR 全景漫游与图文介绍。', 'https://c73zd07zrkz.720yun.com/vr/c1aje0hm5f2', 17, 8, 1),
(9,  '西部山区道路运输安全警示教育基地', '西部山区安全基地', '面向山区道路运输场景的典型案例与安全警示教育，支持 VR 全景漫游与图文介绍。', 'https://c73zd07zrkz.720yun.com/vr/8a1je0hm5k4', 17, 9, 1),
(10, '节水宣传教育中心', '节水宣传中心', '节水理念、技术与宣传教育成果展示。', 'https://c73zd07zrkz.720yun.com/vr/f7bj5pmOkO2', 18, 10, 1),
(11, '牙舟陶数字展厅', '牙舟陶展厅', '国家级非物质文化遗产牙舟陶数字展陈，汇集百余件 3D 数字化展品，依托 VR 全景漫游赏析器物造型、窑变釉色与民俗纹饰，感受贵州本土陶艺魅力。', 'https://c73zd07zrkz.720yun.com/vr/e96je04kew9', 16, 11, 1);

-- INSERT IGNORE 不会覆盖已入库的 8/9 号馆。已有库再跑本文件时回填 720yun 链接并改掉「筹备中」。
UPDATE `hall` SET
  `intro` = '校园安全常识、应急演练与警示教育，支持 VR 全景漫游与图文介绍。',
  `vr_url` = 'https://c73zd07zrkz.720yun.com/vr/c1aje0hm5f2'
WHERE `id` = 8;
UPDATE `hall` SET
  `intro` = '面向山区道路运输场景的典型案例与安全警示教育，支持 VR 全景漫游与图文介绍。',
  `vr_url` = 'https://c73zd07zrkz.720yun.com/vr/8a1je0hm5k4'
WHERE `id` = 9;
