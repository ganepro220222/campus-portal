...
-- 展馆（11 馆）
INSERT IGNORE INTO `hall` (`id`, `name`, `intro`, `category_id`, `sort`, `status`) VALUES
(1,  '阳明文化馆', '龙场悟道 · 知行合一', 4, 1, 1),
(2,  '屯堡文化馆', '六百年江南遗风', 4, 2, 1),
(3,  '红色文化馆', '长征转折 · 红色基因', 5, 3, 1),
(4,  '民族文化馆', '多彩黔中 · 民族瑰宝', 4, 4, 1),
(5,  '交通文化馆', '通途之路 · 交通报国', 7, 5, 1),
(6,  '廉政文化馆', '清风正气 · 廉洁修身', 5, 6, 1),
(7,  '非遗技艺馆', '活态传承 · 匠心独运', 6, 7, 1),
(8,  '校史馆',     '栉风沐雨 · 弦歌不辍', 7, 8, 1),
(9,  '书法艺术馆', '翰墨丹青 · 笔走龙蛇', 6, 9, 1),
(10, '茶文化馆',   '黔茶飘香 · 茶道人生', 4, 10, 1),
(11, '农耕文化馆', '二十四节气 · 农事智慧', 6, 11, 1);

INSERT IGNORE INTO `hall_media` (`hall_id`, `media_type`, `url`, `caption`, `sort`) VALUES
(1, 'image', 'https://cdn.example.com/hall/yangming-1.jpg', '阳明先生像 · 龙场悟道', 1),
(1, 'image', 'https://cdn.example.com/hall/yangming-2.jpg', '心学典籍展陈', 2),
(1, 'audio', '', '语音讲解 03:48', 3);
...
('hall', 1, '阳明文化馆', '龙场悟道 · 知行合一', 1, '2026-01-01 00:00:00'),
('hall', 2, '屯堡文化馆', '六百年江南遗风', 1, '2026-01-01 00:00:00'),
